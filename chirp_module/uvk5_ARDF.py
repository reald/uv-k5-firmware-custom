...
# Adapted For UV-K5 ARDF custom software by reald
#
...
class UVK5RadioEgzumer(uvk5.UVK5RadioBase):
    ...
    def k5_approve_firmware(cls, firmware):
        return firmware.startswith('ARDF ')
    ...
    def _get_mem_mode(self, _mem):
        ...
        temp_modul = _mem.modulation * 2 + somenarrowmode
    ...
    def _set_mem_mode(self, _mem, mode):
        ...
        if mode == "FM":
            ...
            _mem.modulation = 1
            _mem.bandwidth = 1 # AM is NAM in ARDF firmware
        elif mode == "NAM":
            _mem.modulation = 1 # 
            _mem.bandwidth = 3  # NAM uses U- = 1.7kHz as default narrow bandwidth in ARDF firmware
        elif mode == "USB":
            _mem.modulation = 2
            _mem.bandwidth = 3  # USB uses U- = 1.7kHz as default narrow bandwidth in ARDF firmware
