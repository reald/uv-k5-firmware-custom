...
uint16_t ardf_gain_table[] =
{
	0x0000,         //   0 .. 0 0 0 0 .. -27dB -25dB -6dB -32dB .. -90dB
	0x0020,         //   1 .. 0 1 0 0 .. -27dB -20dB -6dB -32dB .. -85dB
	0x0128,         //   2 .. 1 1 1 0 .. -24dB -20dB -4dB -32dB .. -80dB
	0x0060,         //   3 .. 0 3 0 0 .. -27dB -10dB -6dB -32dB .. -75dB
	0x0202,         //   4 .. 2 0 0 2 .. -19dB -25dB -6dB -20dB .. -70dB
	0x0081,         //   5 .. 0 4 0 1 .. -27dB  -6dB -6dB -26dB .. -65dB
	0x0053,         //   6 .. 0 2 2 3 .. -27dB -16dB -2dB -15dB .. -60dB
	0x00AA,         //   7 .. 0 5 1 2 .. -27dB  -4dB -4dB -20dB .. -55dB
	0x004E,         //   8 .. 0 2 1 6 .. -27dB -16dB -4dB  -3dB .. -50dB
	0x02E2,         //   9 .. 2 7 0 2 .. -19dB   0dB -6dB -20dB .. -45dB
	0x02B3,         //  10 .. 2 5 2 3 .. -19dB  -4dB -2dB -15dB .. -40dB
	0x0097,         //  11 .. 0 4 2 7 .. -27dB  -6dB -2dB   0dB .. -35dB
	0x01B7,         //  12 .. 1 5 2 7 .. -24dB  -4dB -2dB   0dB .. -30dB
	0x0392,         //  13 .. 3 4 2 2 ..   0dB  -6dB -2dB -20dB .. -28dB
	0x0336,         //  14 .. 3 1 2 6 ..   0dB -20dB -2dB  -3dB .. -25dB
	0x034F,         //  15 .. 3 2 1 7 ..   0dB -16dB -4dB   0dB .. -20dB
	0x039C,         //  16 .. 3 4 3 4 ..   0dB  -6dB  0dB  -9dB .. -15dB
	0x03A7,         //  17 .. 3 5 0 7 ..   0dB  -4dB -6dB   0dB .. -10dB
	0x03DE,         //  18 .. 3 6 3 6 ..   0dB  -2dB  0dB  -3dB ..  -5dB
	0x03FF,         //  19 .. 3 7 3 7 ..   0dB   0dB  0dB   0dB ..   0dB
};
...
void ARDF_GainIncr(void)
{
	...
	if ( ARDF_ActVfoHasGainRemember(vfo) == false )
	{
        ...
        if ( ardf_gain_index[vfo][activefox] < (sizeof(ardf_gain_table)/sizeof(uint16_t))-1 )
        {
...
{
	BK4819_WriteRegister(BK4819_REG_13, ardf_gain_table[ ARDF_Get_GainIndex(gEeprom.RX_VFO) ]);
	gARDFRssiMax = 0;
	gUpdateDisplay = true;
}
